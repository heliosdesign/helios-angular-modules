(function(window, angular, undefined) {'use strict';
    angular.module('heliosServices', ['ng'])
        .factory('mediaTests', function($rootScope) {
            ...
            var videoType = function() {
                ...
                if (testEl.canPlayType) {
                    ...
                    for (var i=0; i<codex.length; i++) {
                        if (testEl.canPlayType(codex[i][0])) {
                            return codex[i][1];
                        }
                    }
                }
            ...
            var audioType = function() {
                ...
                if (testEl.canPlayType) {
                    ...
                    if ('' !== testEl.canPlayType('audio/ogg; codecs="vorbis"')) { return '.ogg'; }
                }            
            }

            var initiate = function(el, playVid) {
                ...
                var init = {
                    audio: function() {
                        ...
                        aud.play();
                        aud.pause();
                        // $rootScope.client.audioInitiated = 'pending';
                        $rootScope.client.elementInitiated[el] = 'pending';
                    },
                    video: function() {
                        var vid = elem;
                        vid.load();
                        ...
                        //     vid.pause();
                        // }
                        $rootScope.client.elementInitiated[el] = true;
                    }
                }

                if (type === 'audio' && $rootScope.client.webAudio) return;
                if ($rootScope.client.elementInitiated[el]) return;
                init[type]();
            }

            var autoplay = function(cb) {
                var delay = 500;
                ...
                //test for autoplay, 500 ms buffer   
                setTimeout(function(){
                    if(!base64_test_video.paused){
                        $rootScope.client.autoplay = true;
                    } else {
                        $rootScope.client.autoplay = false;
                    }
